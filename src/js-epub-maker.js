import console from "./js/util/console";
import slugify from "./js/util/slugify";
import Handlebars, { template } from "handlebars";
// import ajax from './js/util/ajax';
import epub_types from "./js/epub-types.js";
// import D from "./d.js";
import idpfWastelandBuilder from "./js/template-builders/idpf-wasteland-builder.js";
var mimetypes = {
    'jpeg': 'image/jpeg',
    'jpg': 'image/jpeg',
    'bmp': 'image/bmp',
...
var templateManagers = {
    'idpf-wasteland': idpfWastelandBuilder
...
class EpubMaker {
    constructor() {
        var self = this;
        var epubConfig = { toc: [], landmarks: [], sections: [], stylesheet: {}, templateName: 'idpf-wasteland' };
...
EpubMaker.epubtypes = epub_types
